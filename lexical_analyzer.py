...
def throwError(error_message):
    global line_index
    print(f'An error has be found in line {line_index}.')
...
def classifiesToken(stack):
    ...
    if (recognizesInteger(stack)):
        ...
        throwError(f"Palavra {stack} não reconhecida.")
...
def main(input):
    ...
    try:
        ...
        tokens_list.append(Token(lexeme='class', lexeme_class='reserved'))
        tokens_list.append(Token(lexeme='BAKERY', lexeme_class='id'))
        tokens_list.append(Token(lexeme='feature', lexeme_class='reserved'))
        tokens_list.append(Token(lexeme='numberofcakes', lexeme_class='id'))
        tokens_list.append(Token(lexeme=':', lexeme_class='opr'))
        tokens_list.append(Token(lexeme='INTEGER', lexeme_class='reserved'))
        tokens_list.append(Token(lexeme='-- A variable containing an integer', lexeme_class='comment'))
        tokens_list.append(Token(lexeme='buycake', lexeme_class='id'))
        tokens_list.append(Token(lexeme='(', lexeme_class='del'))
        tokens_list.append(Token(lexeme='amount', lexeme_class='id'))
        tokens_list.append(Token(lexeme=':', lexeme_class='opr'))
        tokens_list.append(Token(lexeme='INTEGER', lexeme_class='reserved'))
        tokens_list.append(Token(lexeme=',', lexeme_class='del'))
        tokens_list.append(Token(lexeme='price', lexeme_class='id'))
        tokens_list.append(Token(lexeme=':', lexeme_class='opr'))
        tokens_list.append(Token(lexeme='INTEGER', lexeme_class='reserved'))
        tokens_list.append(Token(lexeme=')', lexeme_class='del'))
        tokens_list.append(Token(lexeme='-- A function accepting arguments', lexeme_class='comment'))
        tokens_list.append(Token(lexeme='do', lexeme_class='reserved'))
        tokens_list.append(Token(lexeme='-- Some code here...', lexeme_class='comment'))
        tokens_list.append(Token(lexeme='end', lexeme_class='reserved'))
        tokens_list.append(Token(lexeme='iscakeavailable', lexeme_class='id'))
        tokens_list.append(Token(lexeme=':', lexeme_class='opr'))
        tokens_list.append(Token(lexeme='BOOLEAN', lexeme_class='id'))
        tokens_list.append(Token(lexeme='-- A function returning true or false ', lexeme_class='comment'))
        tokens_list.append(Token(lexeme='do', lexeme_class='reserved'))
        tokens_list.append(Token(lexeme='Result', lexeme_class='id'))
        tokens_list.append(Token(lexeme=':=', lexeme_class='opr'))
        tokens_list.append(Token(lexeme='numberofcakes', lexeme_class='id'))
        tokens_list.append(Token(lexeme='>', lexeme_class='opr'))
        tokens_list.append(Token(lexeme='0', lexeme_class='int'))
        tokens_list.append(Token(lexeme='end', lexeme_class='reserved'))
        tokens_list.append(Token(lexeme='end', lexeme_class='reserved'))
